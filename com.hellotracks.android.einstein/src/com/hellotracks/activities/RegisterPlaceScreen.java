...
public class RegisterPlaceScreen extends RegisterScreen {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        position = new LatLng(getIntent().getDoubleExtra("lat", 0), getIntent().getDoubleExtra("lng", 0));
        ...
        extension.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
    ...
    public void onCreate(View view) {
        try {
            final String name = placeName.getText().toString().trim()
                    .replaceAll("\n", "");

            if (name.length() == 0) {
                Toast.makeText(this, getResources().getString(R.string.InvalidPlaceName), Toast.LENGTH_LONG).show();
                throw new Exception();
            }
            ...
            if (lat + lng == 0) {
                ...
                alert.setMessage(getResources().getString(R.string.CurrentLocationUnavailable));
                alert.setPositiveButton(getResources().getString(R.string.CreateAnyhow), new OnClickListener() {
                ...
                alert.setNegativeButton(getResources().getString(R.string.Cancel), new OnClickListener() {
    ...
    private void send(String name, String owner, int radiusMeter, double latitude, double longitude)
        ...
        doAction(AbstractScreen.ACTION_REGISTER, registerObj, msg, new ResultWorker() {
            ...
            public void onResult(String result, Context context) {
                Toast.makeText(RegisterPlaceScreen.this,
                        getResources().getString(R.string.placeRegisteredSuccessfully), Toast.LENGTH_LONG).show();
                finish();
            }
