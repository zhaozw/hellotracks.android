...
public class ProfileSettingsScreen extends AbstractScreen {
            ...
            if (isPlace) {
                ...
                radiusSeekBar.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
                    ...
                    public void onProgressChanged(SeekBar seekBar, int p, boolean fromUser) {
                        radiusLabel.setText(RegisterPlaceScreen.fromProgressToText(p));
                    }
                });
                radiusSeekBar.setProgress(RegisterPlaceScreen.fromMeterToProgress(radius));
            } else {
    ...
    public void onSave(View view) {
        try {
            ...
            if (radius > 0) {
                int radiusMeter = RegisterPlaceScreen.fromProgressToMeter(radiusSeekBar.getProgress());
