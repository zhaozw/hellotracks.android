...
public class HomeMapScreen extends AbstractMapScreen {
    ...
    private void refillTrackActions(final TrackLine animate, final Animation animation) {
            ...
            for (final TrackLine line : visibleTracks.values().toArray(new TrackLine[0])) {
                ...
                image.setOnLongClickListener(new OnLongClickListener() {
                    ...
                    public boolean onLongClick(View v) {
                        ActionItem start = new ActionItem(HomeMapScreen.this, R.string.JumpToStart);
                        ActionItem end = new ActionItem(HomeMapScreen.this, R.string.JumpToEnd);
                        ActionItem startAnimation = new ActionItem(HomeMapScreen.this, R.string.StartAnimation);
                        ActionItem infoItem = new ActionItem(HomeMapScreen.this, R.string.TrackInfoAndTools);
                        ActionItem removeItem = new ActionItem(HomeMapScreen.this, R.string.RemoveFromMap);
