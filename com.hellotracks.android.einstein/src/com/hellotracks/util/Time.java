...
public class Time {
	...
	public static final String formatTimePassed(Context context, long timestamp) {
		...
		if (time < 60 * SECONDS)
			return seconds == 1 ? r.getString(R.string.OneSecondAgo) : r
					.getString(R.string.SecondsAgo, seconds);

		if (time < 60 * MINUTE)
			return minutes == 1 ? r.getString(R.string.OneMinuteAgo) : r
					.getString(R.string.MinutesAgo, minutes);
