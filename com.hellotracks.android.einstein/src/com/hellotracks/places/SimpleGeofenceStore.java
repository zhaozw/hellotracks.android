...
public class SimpleGeofenceStore {
    ...
    public static final String KEY_NAME = "ht.geofence.KEY_NAME";
    /*
    ...
    public SimpleGeofence getGeofence(String id) {
        ...
        String name = mPrefs.getString(getGeofenceFieldKey(id, KEY_NAME), "");
     ...
     * 
     * @param geofence
     *            The SimpleGeofence containing the values you want to save in SharedPreferences
     */
    public void setGeofence(String id, SimpleGeofence geofence) {
        ...
        editor.putString(KEY_NAME, geofence.getName());

        String ids = mPrefs.getString("ids", "");
        editor.putString("ids", ids + "," + id);
    ...
    public void clearGeofence(String id) {
        ...
        String ids = mPrefs.getString("ids", "");
        editor.putString("ids", ids.replace(id, ""));
        editor.commit();

        ArrayList<String> list = new ArrayList<String>();
        list.add(id);
        new GeofenceRemover(context).removeGeofencesById(list);
    }

    /**
     * Given a Geofence object's ID and the name of a field (for example, KEY_LATITUDE), return the key name of the
