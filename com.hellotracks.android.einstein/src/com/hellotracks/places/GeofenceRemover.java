 ...
 * <p>
 * <b> Note: Clients must ensure that Google Play services is available before removing geofences. </b> Use
 * GooglePlayServicesUtil.isGooglePlayServicesAvailable() to check.
 * <p>
 * To use a GeofenceRemover, instantiate it, then call either RemoveGeofencesById() or RemoveGeofencesByIntent().
...
public class GeofenceRemover implements ConnectionCallbacks, OnConnectionFailedListener,
    ...
    /**
     * Set the "in progress" flag from a caller. This allows callers to re-set a request that failed but was later
     * fixed.
     * 
     * @param flag
    ...
    /**
     * Remove the geofences in a list of geofence IDs. To remove all current geofences associated with a request, you
     * can also call removeGeofencesByIntent.
     * <p>
    ...
    /**
     * Remove the geofences associated with a PendIntent. The PendingIntent is the one used in the request to add the
     * geofences; all geofences in that request are removed. To remove a subset of those geofences, call
     * removeGeofencesById().
     * 
     * @param requestIntent
    ...
    /**
     * Once the connection is available, send a request to remove the Geofences. The method signature used depends on
     * which type of remove request was originally received.
     */
    ...
    public void onRemoveGeofencesByPendingIntentResult(int statusCode, PendingIntent requestIntent) {
        ...
        if (statusCode == LocationStatusCodes.SUCCESS) {
            ...
            Log.e(GeofenceUtils.APPTAG, mContext.getString(R.string.remove_geofences_intent_failure, statusCode));
    ...
    public void onRemoveGeofencesByRequestIdsResult(int statusCode, String[] geofenceRequestIds) {
        ...
        if (LocationStatusCodes.SUCCESS == statusCode) {
             ...
             */
            msg = mContext.getString(R.string.remove_geofences_id_failure, statusCode,
