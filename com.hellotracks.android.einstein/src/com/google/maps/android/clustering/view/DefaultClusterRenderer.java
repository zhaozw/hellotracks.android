...
public class DefaultClusterRenderer<T extends ClusterItem> implements ClusterRenderer<T> {
    ...
    /**
     * Gets the "bucket" for a particular cluster. By default, uses the number of points within the cluster, bucketed to
     * some set points.
     */
    ...
    /**
     * ViewModifier ensures only one re-rendering of the view occurs at a time, and schedules re-rendering, which is
     * performed by the RenderTask.
     */
    ...
    /**
     * Transforms the current view (represented by DefaultClusterRenderer.mClusters and DefaultClusterRenderer.mZoom) to
     * a new zoom level and set of clusters.
     * <p/>
     ...
     * <p/>
     * When zooming in, markers are animated out from the nearest existing cluster. When zooming out, existing clusters
     * are animated to the nearest new cluster.
     */
    ...
    private class MarkerModifier extends Handler implements MessageQueue.IdleHandler {
        ...
        public boolean isBusy() {
            return !(mCreateMarkerTasks.isEmpty() && mOnScreenCreateMarkerTasks.isEmpty()
                    && mOnScreenRemoveMarkerTasks.isEmpty() && mRemoveMarkerTasks.isEmpty() && mAnimationTasks
                        .isEmpty());
        }
    ...
    /**
     * Called before the marker for a Cluster is added to the map. The default implementation draws a circle with a
     * rough count of the number of items.
     */
    ...
    private class CreateMarkerTask {
         ...
         * @param animateFrom
         *            the location to animate the markerWithPosition from, or null if no animation is required.
         */
        ...
        private void perform(MarkerModifier markerModifier) {
            ...
            MarkerOptions markerOptions = new MarkerOptions().position(animateFrom == null ? cluster.getPosition()
                    : animateFrom);
    ...
    /**
     * A Marker and its position. Marker.getPosition() must be called from the UI thread, so this object allows lookup
     * from other threads.
     */
    ...
    /**
     * Animates a markerWithPosition from one position to another. TODO: improve performance for slow devices (e.g.
     * Nexus S).
     */
